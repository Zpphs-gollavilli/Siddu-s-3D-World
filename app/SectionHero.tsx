            ...
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    <motion.p
                        ...
                        aria-label="Welcome to Siddu's 3D World"
                    >
                        Welcome to Siddu&apos;s 3D World
                    </motion.p>
                    ...
                    <motion.p
                        ...
                        aria-label="I'm Siddharth Guttula. A passionate Full Stack Web Developer based in Andhra Pradesh, India."
                    >
                ...
                <div className='xl:order-2'>
                    <div className='relative flex items-center justify-center order-1 xl:justify-end'>
                        <div className='relative'>
                            <motion.div
                                className='relative w-[280px] h-[280px] md:w-[330px] md:h-[330px] lg:w-[480px] lg:h-[480px] bg-gray rounded-3xl overflow-hidden shadow-lg'
                            >
                                <AnimatedImage
